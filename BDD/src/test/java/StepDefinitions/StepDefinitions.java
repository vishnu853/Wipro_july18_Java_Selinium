...
public class StepDefinitions 
{
	...
	public void user_enters_the_password() throws Exception
	{
	...
	public void user_is_dispalyed_as_invalid_credentials() throws InterruptedException 
	{
		WebElement invalid=driver.findElement(By.xpath("//div[@class='orangehrm-login-slot']"));
		...
		{
			System.out.println("Reenter the username and password");
		}
		Thread.sleep(1000);
	}
